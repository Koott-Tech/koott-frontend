    ...
    return (
      <div className="min-h-screen bg-[#fafafa] flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-8 w-8 border-2 border-slate-200 border-t-[#025545] mx-auto"></div>
        ...
        <div className={`${showChatScreen ? 'hidden' : 'block'}`}>
          {isLoading ? (
            <div className="flex justify-center py-16">
              <div className="animate-spin rounded-full h-8 w-8 border-2 border-slate-200 border-t-[#025545]"></div>
            </div>
                    ...
                    <li key={conversation.id}>
                      ...
                      >
                        <div className={`w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-medium ${
                          isSelected ? 'bg-[#025545] text-white' : 'bg-slate-100 text-slate-600'
                        }`}>
            ...
            <div className="bg-white border-t border-gray-200 p-3 sm:p-4 flex-shrink-0">
              <form onSubmit={handleSendMessage} className="flex space-x-2">
                <input
                  ...
                  className="flex-1 border border-gray-300 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#025545]"
                />
                <button
                  type="submit"
                  disabled={!newMessage.trim() || isSending}
                  className="bg-[#025545] text-white p-2 rounded-full hover:bg-[#012f23] disabled:opacity-50 disabled:cursor-not-allowed"
                >
